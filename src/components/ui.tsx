...
export function RankBadge({
  ...
  return (
    <span
      className={cx(
        "inline-flex h-10 min-w-12 items-center justify-center rounded-lg border px-2.5 text-sm font-black tabular-nums transition-colors sm:h-12 sm:min-w-16 sm:text-base",
        topRank,
        className,
      )}
    >
